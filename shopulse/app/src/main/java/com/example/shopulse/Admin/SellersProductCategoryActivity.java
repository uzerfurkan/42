   ...
   // private Button LogoutBtn, CheckOrdersBtn, maintainProducsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        maintainProducsBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(SellersProductCategoryActivity.this, HomeActivity.class);
        ...
        LogoutBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(SellersProductCategoryActivity.this, MainActivity.class);
        ...
        CheckOrdersBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(SellersProductCategoryActivity.this, AdminNewOrdersActivity.class);
                startActivity(intent);
            }
        });*/

...
public class SellerRegistrationActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        emailInput = findViewById(R.id.seller_emailAddress);
    ...
    private void registerSeller() 
    {
        ...
        {
            loadingBar.setTitle("Satıcı Hesabınız Oluşturuluyor");
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                rootRef.child("Sellers").child("sid").updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>()
                                        {
                                            ...
                                            {
                                                loadingBar.dismiss();
                                                Toast.makeText(SellerRegistrationActivity.this, "Başarıyla Kayıt Oldunuz.", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        }
        ...
        {
            Toast.makeText(this, "Lütfen formu eksiksiz doldurun", Toast.LENGTH_SHORT).show();
        }
